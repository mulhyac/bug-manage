...
public class OrgUserForm extends BaseForm<Long> {
     ...
     * 组织uuid
     */
    @NotNull(message = "请输入组织uuid",groups = {UpdateGroup.class,InsertGroup.class})
    private String orgUuid;
    /**
     * 用户uuid
     */
    @NotNull(message = "请输入用户uuid",groups = {UpdateGroup.class,InsertGroup.class})
    private String userUuid;
    /**
     * 姓名
     */
    /*@Length(max = 50, message = "用户名称应该在50个字符内", groups = {InsertGroup.class})*/
    private String name;
    /**
     * 职位
     */
    @Length(max = 50, message = "职位应该在50个字符内", groups = {InsertGroup.class})
